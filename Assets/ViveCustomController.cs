...
public class ViveCustomController : MonoBehaviour {
	...
	Vector3 initRight = Vector3.right.normalized;
	Vector3 initUp = Vector3.up.normalized;
	Vector3 initForward = Vector3.forward.normalized;
    ...
    {
		Vector3 rightXZ = Vector3.ProjectOnPlane(controllerRot.right, initUp).normalized;
